...
class VanillaPlusVariantProvider implements ModelVariantProvider {
	...
	protected Map<Identifier, GroupedBlock> coveredBlocks = new HashMap<>();
	...
	public void cover(GroupedBlock block) {
		coveredBlocks.put(new Identifier(ConventionalCubesMod.MODID, block.getId()), block);
	}
	...
	public @Nullable UnbakedModel loadModelVariant(ModelIdentifier modelId, ModelProviderContext context) throws ModelProviderException {
		...
		if (variant.equals("inventory")) {
			...
			if (item instanceof BlockItem blockItem) {
				...
				Identifier blockId = Registry.BLOCK.getId(block); //Usually the same as itemId BUT NOT REQUIRED TO BE
